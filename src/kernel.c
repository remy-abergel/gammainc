 ...
 * ----------
 *
 * + R. Abergel and L. Moisan. Algorithm 1006: Fast and Accurate Evaluation of a
 *   Generalized Incomplete Gamma Function, ACM Transactions on Mathematical 
 *   Software, Volume 46, Issue 1, March 2020, DOI : 10.1145/3365983.
 *
...
{
  double mA,mB,mx,my,nA,nB,nx,ny,m_abserr_diff,n_abserr_diff,gln;
